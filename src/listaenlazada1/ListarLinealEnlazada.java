...
public class ListarLinealEnlazada {
    ...
    public static ArrayList<Nodo> DevuelveListaEnlazada(
        ...
        ArrayList<Nodo> oLista = new ArrayList<>();
    ...
    public void ImprimirListaLinealEnlazadaOrdenada(ArrayList<Nodo> Lista)
    {
        ...
        for(int i=0;i<Lista.size();i++){
            ...
            if(Lista.get(j).getDato()>Lista.get(j+1).getDato()){
                aux=Lista.get(j).getDato();
                Lista.get(j).setDato(Lista.get(j+1).getDato());
                Lista.get(j+1).setDato(aux);
            }
            }
        }
